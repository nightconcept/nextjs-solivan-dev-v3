...
export default function TableOfContents({ items }: TableOfContentsProps) {
  ...
  return (
    <div className="fixed right-4 bottom-16 z-10">
      {/* Wide hover area */}
      <div className="absolute right-0 bottom-0 h-32 w-32" onMouseEnter={() => setIsOpen(true)}></div>
      ...
      <div className="relative" onMouseEnter={() => setIsOpen(true)}>
        ...
        {isOpen && (
          <>
            {/* Large invisible overlay to handle closing on mouse leave */}
            <div
            ...
            <div className="absolute right-14 bottom-0 bg-surface dark:bg-surface-dark rounded-lg shadow-lg p-4 min-w-[200px] max-w-[250px] z-20">
