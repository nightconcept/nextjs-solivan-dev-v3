...
describe('Button Component', () => {
  ...
  variants.forEach((variant) => {
    ...
    it(`renders correctly with variant "${String(variant)}"`, () => {
      ...
      expect(screen.getByRole('button', { name: `Variant ${String(variant)}` })).toBeInTheDocument();
    });
  });
  ...
  it('forwards ref correctly', () => {
   ...
   it('renders icon variant correctly', () => {
    render(<Button variant="outline" size="icon" aria-label="Settings"><span data-testid="icon-child">⚙️</span></Button>);
