...
vi.mock('next/navigation', () => ({
    notFound: vi.fn(() => { throw new Error("Mocked notFound called"); }), // Throw error to check if it's called unexpectedly
}));
...
All in all, I want to take these next four years as a chance to grow and do something productive for me. I will not wallow in loss.`
        ...
        const mockAllPosts = [
            ...
            { slug: 'another-post', title: 'Another Post', date: '2024-11-07T00:00:00-08:00', dateObject: new Date('2024-11-07T00:00:00-08:00') },
            { slug: slug, title: 'A New Path', date: '2024-11-06T10:28:03-08:00', dateObject: new Date('2024-11-06T10:28:03-08:00') },
            { slug: 'older-post', title: 'Older Post', date: '2024-11-05T00:00:00-08:00', dateObject: new Date('2024-11-05T00:00:00-08:00') },
        ];
