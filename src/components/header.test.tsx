...
import { beforeEach, describe, expect, it, vi } from "vitest"; // Import from vitest
...
describe("Header Component", () => {
  ...
  describe("Mobile Menu Interaction", () => {
    ...
    it("opens the mobile menu on button click", () => {
      ...
      const blogLinkInMobile = screen
        .getAllByRole("link", { name: "Blog" })
        .find((link) => link.closest(".sm\\:hidden"));
      ...
      const aboutLinkInMobile = screen
        .getAllByRole("link", { name: "About" })
        .find((link) => link.closest(".sm\\:hidden"));
      expect(aboutLinkInMobile).toBeInTheDocument();
      const themeToggleInMobile = screen
        .getAllByTestId("theme-toggle-mock")
        .find((toggle) => toggle.closest(".sm\\:hidden"));
    ...
    it("closes the mobile menu when a link inside it is clicked", () => {
      // Menu is opened in beforeEach
      const blogLinkInMobileMenu = screen
        .getAllByRole("link", { name: "Blog" })
        .find((link) => link.closest(".sm\\:hidden"));
