import { beforeEach, describe, expect, it, vi } from "vitest"; // Removed unused afterEach
...
describe("Blog Page Component (app/blog/page.tsx)", () => {
  ...
  it("renders core elements (header, footer, heading)", async () => {
    ...
    expect(screen.getByRole("heading", { name: /blog posts/i }))
      .toBeInTheDocument();
  ...
  it("passes correct posts and default page number (1) to BlogPostList when no page param exists", async () => {
    ...
    const MockBlogPostList =
      (await import("@/components/blog-post-list")).default;
